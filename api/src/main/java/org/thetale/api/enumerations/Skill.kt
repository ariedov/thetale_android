...
enum class Skill constructor(val skillName: String, val description: String, val maxLevel: Int, val type: SkillType,
                                     val availability: SkillAvailability, val method: SkillMethod, val isDirectDamage: Boolean) {
